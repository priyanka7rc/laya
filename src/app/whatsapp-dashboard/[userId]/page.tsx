    ...
    return (
      <div className="min-h-screen bg-background p-8">
        <div className="max-w-6xl mx-auto">
          <p className="text-danger-foreground">User not found</p>
          <Link href="/whatsapp-dashboard" className="text-primary hover:text-primary/80 underline">
            ← Back to dashboard
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <Link
            ...
            className="text-primary hover:text-primary/80 font-medium mb-4 inline-block transition-colors"
          >
            ← Back to Dashboard
          </Link>
                      ...
                      <div
                        className={`max-w-[70%] rounded-lg px-4 py-2 ${
                          msg.direction === 'inbound'
                            ...
                            : 'bg-green-500 text-white' /* WhatsApp outbound: intentional brand green */
                        }`}
                      >
          ...
          <div className="space-y-6">
              ...
              <div className="p-6 space-y-3">
                {pendingTasks.length === 0 ? (
                  ...
                  pendingTasks.map((task) => (
                    <div key={task.id} className="pb-3 border-b border-border last:border-0">
                  ...
                  <details className="mt-4">
                    ...
                    <div className="mt-2 space-y-2">
                      {completedTasks.map((task) => (
                        <p key={task.id} className="text-sm text-muted-foreground line-through">
                          ✓ {task.title}
                        </p>
                      ))}
                    </div>
            ...
            <div className="bg-card border border-border rounded-lg">
              ...
              <div className="p-6 space-y-2">
                {groceries.length === 0 ? (
                  <p className="text-muted-foreground text-sm">No groceries</p>
                ) : (
                ...
                <div className="p-6 space-y-2">
                  {moods.map((mood) => (
                    <div key={mood.id} className="flex items-center justify-between">
                      <span className="text-foreground capitalize">{mood.tag}</span>
