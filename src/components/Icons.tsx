...
export function TypeTask({ className, size = defaultSize }: IconProps) {
  return (
...
export function Brain({ className, size = defaultSize }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} width={size} height={size}>
...
export function Upload({ className, size = defaultSize }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} width={size} height={size}>
...
export function ListPlus({ className, size = defaultSize }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} width={size} height={size}>
...
export function ShoppingCart({ className, size = defaultSize }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} width={size} height={size}>
...
export function Book({ className, size = defaultSize }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} width={size} height={size}>
...
export function Gift({ className, size = defaultSize }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} width={size} height={size}>
...
export function Briefcase({ className, size = defaultSize }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} width={size} height={size}>
...
export function ListIconForName(name: string): ComponentType<IconProps> {
  const lower = (name || "").toLowerCase();
  if (lower.includes("grocery") || lower.includes("groceries")) return ShoppingCart;
  if (lower.includes("book")) return Book;
  if (lower.includes("home")) return Home;
  if (lower.includes("gift")) return Gift;
  if (lower.includes("meeting") || lower.includes("work")) return Briefcase;
  return ListIcon;
}

export function emojiForListName(name: string): string {
  const lower = (name || "").toLowerCase();
